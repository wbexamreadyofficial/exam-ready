...
export const translations = {
  BN: {
    ...
    hero: {
      ...
      title2: 'অনুশীলন।',
      title3: 'সাফল্য।',
      subtitle: 'ডাব্লুবি কনস্টেবল, ডাব্লুবি এসআই, ফুড এসআই, পিএসসি ক্লার্কশিপ, ও প্রাইমারি টেট পরীক্ষার সেরা প্রস্তুতি প্ল্যাটফর্ম।',
      searchPlaceholder: 'পরীক্ষা খুঁজুন (যেমন: পিএসসি ক্লার্কশিপ, ডাব্লুবি কনস্টেবল, ফুড এসআই)...',
      findExam: 'পরীক্ষা খুঁজুন',
      startFree: 'বিনামূল্যে প্রস্তুতি শুরু করুন ➔',
    ...
    trending: {
      title: 'হট ও ট্রেন্ডিং মক পরীক্ষা',
      subtitle: 'হাজার হাজার পরীক্ষার্থীর সাথে লাইভ টেস্ট পেপারে অংশ নিন।',
      viewAll: 'সকল টেস্ট দেখুন ➔',
      attempt: 'টেস্ট দিন ➔',
    },
    categories: {
      title: 'টার্গেটেড পরীক্ষার মডিউল',
      subtitle: 'আপনার লক্ষ্যভিত্তিক প্রতিযোগিতামূলক পরীক্ষা বেছে নিয়ে মক টেস্ট শুরু করুন।',
    ...
    features: {
      ...
      subtitle: 'আমাদের প্ল্যাটফর্মের বিশেষ সুবিধাসমূহ যা আপনাকে পরীক্ষায় এগিয়ে রাখবে।',
      f1Title: 'রিয়েল এক্সাম টাইমার',
      f1Desc: 'আসল পরীক্ষার সময়সীমার অভিজ্ঞতা নিন। আমাদের টাইমার TCS পরীক্ষার প্যাটার্নের সাথে হুবহু মিল রেখে তৈরি।',
      f2Title: 'বিস্তারিত ফলাফল বিশ্লেষণ',
      f2Desc: 'বিষয়ভিত্তিক পারফরম্যান্স চার্ট ও নির্ভুলতার পরিমাপক দেখে আপনার দুর্বলতা চিহ্নিত করুন।',
      f3Title: 'বিশাল প্রশ্ন ভাণ্ডার',
      f3Desc: '১০,০০০+ নির্বাচিত MCQ ও বিগত বছরের প্রশ্ন সমাধানের সমৃদ্ধ সংগ্রহ।',
      f4Title: 'লাইভ লিডারবোর্ড',
      f4Desc: 'সমগ্র পশ্চিমবঙ্গের পরীক্ষার্থীদের সাথে প্রতিযোগিতা করুন এবং জেলাভিত্তিক র্যাঙ্ক দেখুন।',
      f5Title: 'দৈনিক কুইজ সেট',
      f5Desc: 'প্রতিদিনের ১০-মিনিটের কুইজ যা আপনার প্রস্তুতিকে প্রতিদিন নিয়মিত রাখে।',
    ...
    rankers: {
      ...
      subtitle: 'পশ্চিমবঙ্গের জেলাভিত্তিক পরীক্ষার্থীদের রিয়েল-টাইম র্যাঙ্ক ও পার্সেন্টাইল।',
    },
    steps: {
      badge: 'সহজ ধাপসমূহ',
      ...
      step1Desc: 'বিনামূল্যে রেজিস্টার করুন এবং আপনার টার্গেট পরীক্ষার প্রোফাইল তৈরি করুন।',
    ...
    cta: {
      ...
      subtitle: 'আজই বিনামূল্যে রেজিস্টার করুন এবং লাইভ র্যাঙ্ক ও নেগেটিভ মার্কিং এনালাইসিস সহ মক পরীক্ষা দিন।',
  ...
  EN: {
    ...
    hero: {
      ...
      title2: 'Practice.',
      title3: 'Perform.',
      subtitle: 'Master WB Constable, WB SI, WB Food Inspector, WB Health, PSC Clerkship, PSC Miscellaneous, and Primary Teacher TET exams.',
      searchPlaceholder: 'Search exams (e.g. PSC Clerkship, WB Constable, Food SI)...',
      findExam: 'Find Exam',
      startFree: 'Start Preparing Free ➔',
    ...
    trending: {
      title: 'Hot & Trending Mock Exams',
      subtitle: 'Attempt live test papers attempted by thousands of candidates today.',
      viewAll: 'View All Tests ➔',
      attempt: 'Attempt Test ➔',
    },
    categories: {
      title: 'Targeted Examination Modules',
      subtitle: 'Select your target competitive examination to start practicing with category-specific mock tests.',
    ...
    features: {
      ...
      f1Desc: 'Practice with authentic time pressure matching actual state exam conditions.',
      f2Title: 'Detailed Analytics',
      f2Desc: 'Track your progress with subject-wise performance charts and instant accuracy metrics.',
      f3Title: 'Vast Question Bank',
      f3Desc: '10,000+ curated MCQs covering all topics with PYQ solutions for state exams.',
      f4Title: 'Live Leaderboard',
      f4Desc: 'Compete with candidates statewide and track your rank district-wise.',
      f5Title: 'Daily Quizzes',
      f5Desc: 'Sharp 10-minute daily quizzes to keep your preparation consistent every day.',
      f6Title: 'Answer Explanations',
      f6Desc: 'Every question comes with step-by-step solutions to deepen concept clarity.',
    },
    rankers: {
      badge: 'Statewide Live Leaderboard Spotlight',
      title: 'Top Rankers of the Week',
      subtitle: 'Real-time percentile rankings of top candidates competing across West Bengal districts.',
    },
    steps: {
      badge: 'Simple Steps',
      ...
      step1Desc: 'Register free and set up your candidate profile with your target state exams.',
      step2Title: 'Choose Exam',
      step2Desc: 'Browse mock test series across all 7 specialized West Bengal exam categories.',
      step3Title: 'Practice & Perform',
      step3Desc: 'Attempt full mock exams, experience real timer pressure, and get detailed score cards.',
      step4Title: 'Track Progress',
      step4Desc: 'Monitor improvement with accuracy charts and climb the statewide rank leaderboard.',
    },
    cta: {
      badge: '🚀 Join 50,000+ Candidates Preparing for 2026 State Exams',
      title: 'Ready to Crack WB Police, Food SI & PSC Clerkship?',
      subtitle: 'Register free today and start taking live timed mock tests with instant percentile feedback.',
  ...
  HI: {
    ...
    hero: {
      ...
      title2: 'अभ्यास।',
      title3: 'सफलता।',
      subtitle: 'WB कांस्टेबल, WB SI, फूड SI, PSC क्लर्कशिप, और प्राइमरी TET परीक्षाओं की सर्वश्रेष्ठ तैयारी प्लेटफ़ॉर्म।',
      searchPlaceholder: 'परीक्षा खोजें (जैसे: PSC क्लर्कशिप, WB कांस्टेबल, फूड SI)...',
      findExam: 'परीक्षा खोजें',
      startFree: 'मुफ्त तैयारी शुरू करें ➔',
    ...
    trending: {
      title: 'हॉट और ट्रेंडिंग मॉक परीक्षाएं',
      subtitle: 'हजारों उम्मीदवारों द्वारा दिए जा रहे लाइव टेस्ट पेपर हल करें।',
    ...
    features: {
      ...
      subtitle: 'आपकी सफलता सुनिश्चित करने के लिए विशेष रूप से डिज़ाइन किए गए टूल।',
      ...
      f4Desc: 'राज्यभर के छात्रों के साथ प्रतिस्पर्धा करें और जिलावार रैंक देखें।',
    ...
    rankers: {
      ...
      subtitle: 'पश्चिम बंगाल के जिलों में प्रतिस्पर्धा करने वाले उम्मीदवारों की वास्तविक समय रैंकिंग।',
    },
    steps: {
      badge: 'आसान चरण',
      ...
      step1Desc: 'मुफ्त पंजीकरण करें और अपनी लक्षित परीक्षाओं का प्रोफाइल बनाएं।',
    ...
    cta: {
      ...
      title: 'WB पुलिस, फूड SI और PSC क्लर्कशिप में सफलता पाने के लिए तैयार हैं?',
