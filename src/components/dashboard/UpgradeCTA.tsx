...
export default function UpgradeCTA() {
  return (
    <div
      className="rounded-2xl overflow-hidden px-6 py-5 relative flex items-center justify-between mt-4 shadow-[0_2px_6px_rgba(201,88,23,0.15),0_30px_60px_-28px_rgba(184,67,15,0.7)] ring-1 ring-inset ring-white/25"
      style={{
    ...
    >
      ...
      <div className="relative z-10 max-w-xl">
        ...
        <h2 className="text-xl font-bold text-white mb-1">Unlock Your Full Potential</h2>
        <p className="text-orange-50 text-[13px] mb-3.5 max-w-md">
          Get unlimited access to all mock tests, detailed analytics, and personalized study plans.
        </p>
        <Button className="btn-premium bg-white text-[#b9450d] hover:bg-orange-50 px-3.5 py-1.5 h-auto rounded-md text-[11px] font-bold flex items-center gap-1.5 shadow-md shadow-orange-900/30">
          <Sparkles size={14} />
          Upgrade to Premium
        </Button>
      </div>
