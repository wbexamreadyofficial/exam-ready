...
/** Accordion (one open at a time, animated height) whose items rise in on scroll. */
  ...
  useLayoutEffect(() => {
    ...
    media.add(
      ...
      () => {
        ...
        // One card after another, each landing before the next begins.
        rows.forEach((row, index) => {
          const at = index * 0.22;
          timeline
            .from(row, { y: 44, x: 28, opacity: 0, transition: 'none', duration: 1, force3D: true, clearProps: 'transform,opacity,transition' }, at)
